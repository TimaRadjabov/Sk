...
const CalendarMonthToggle = props => {
	const { nextMonthHandler, prevMonthHandler } = props.monthProps

	return (
		<div className={s.BtnGroupMonth}>
			<button style={{width: '11px'}} onClick={prevMonthHandler}>
			...
			<span className={s.selectedMonth}>{props.monthProps.currentMonth} 2023</span>

			<button style={{width: '11px'}} onClick={nextMonthHandler}>
				<svg width='11' height='20' viewBox='0 0 11 20' fill='none' xmlns='http://www.w3.org/2000/svg'>
					<path
